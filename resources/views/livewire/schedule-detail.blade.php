            ...
            <div class="relative p-4 w-full max-w-4xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form class="p-4 md:p-5">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2">
                                ...
                                <select id="typeOfDefense" wire:model="typeOfDefense"
                                    ...
                                    @foreach (\App\Models\Schedule::DEFENSE_STATUS as $typeOfDefenseKey => $typeOfDefense)
                                        <option value="{{ $typeOfDefenseKey }}">{{ $typeOfDefense }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-span-2">
                                ...
                                <label for="generalComments"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">General Comments/Suggestions
                                </label>
                        ...
                        <!-- Loading Indicator -->
                        <div wire:loading wire:target="uploadRsc">
                            Loading...please wait.
                        </div>
                    </form>
                </div>
